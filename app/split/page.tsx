...
export default function SplitPage() {
  return <main><SiteHeader active="split" /><ToolFrame code="01" name="Image Splitter" summary="Build a grid, adjust the crop, and download every tile in one archive."><ImageSplitterTool /><ToolSeoContent tool="split" /></ToolFrame></main>;
}
