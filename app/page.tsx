...
export default function HomePage() {
  return <main><SiteHeader active="home" />
    ...
    <section className="tool-index" aria-label="Available tools">
      <ToolCard code="01" href="/split/" title="Image Splitter" description="Turn a single image into precise grid tiles for social, print, and layouts." accent="signal" />
      <ToolCard code="02" href="/qr-code/" title="QR Code Generator" description="Create crisp SVG and PNG codes for links, print pieces, Wi‑Fi, and contact details." accent="amber" />
      <ToolCard code="03" href="/raw2dng/" title="RAW to DNG" description="Convert camera RAW files privately, directly in your browser." accent="violet" />
    </section>
  </main>;
}
